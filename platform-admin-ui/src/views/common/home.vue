  ...
  methods: {
    ...
    getDailySummaryTrend () {
      this.$http({
        ...
        if (data && data.code === 0 && data.list.length > 0) {
          this.dailySummary = data.list[0]
        } else {
          this.dailySummary = [{
            'refDate': '',
            'visitTotal': '',
