	...
	export default {
		...
		methods: {
			...
			postComment() {
				let that = this;
				uni.navigateTo({
					url: '/pages/commentPost/commentPost?orderId=' + that.id + '&type=1',
				})
			}
		},
		onShow: function() {
		...
		onShareAppMessage: function() {
			var that = this;
			return {
				title: that.topic.title,
				desc: that.topic.subtitle,
				path: '/pages/topicDetail/topicDetail?id=' + that.topic.id
			}
		},
